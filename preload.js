...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  captureScreenshotForAI: () => ipcRenderer.invoke('capture-screenshot-for-ai'),
  processScreenshotWithPrompt: (prompt) => ipcRenderer.invoke('process-screenshot-with-prompt', prompt),
  hasPendingScreenshot: () => ipcRenderer.invoke('has-pending-screenshot'),
